...
export function meta(_: Route.MetaArgs) {
    return [
        { title: 'Psycho - Professional Mental Health Platform' },
        {
            name: 'description',
            content:
                'Connect with professional psychologists and take control of your mental health journey.',
        },
    ]
}
            ...
            <section className="flex flex-col items-center justify-center py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-4xl text-center space-y-6">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Connect with professional psychologists and take the first step towards
                        better mental health. Our platform makes it easy to find the right support
                        for your needs.
                    </p>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-gray-600">
                                    ...
                                    dedicated to helping you achieve your wellness goals.
                                </p>
                            </CardContent>
                        </Card>
                        <Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <p className="text-gray-600">
                                    Schedule appointments that fit your busy lifestyle with our
            ...
            <section className="py-20 px-4 bg-gray-50">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                    ...
                    <p className="text-xl text-gray-600">
                        Join thousands of people who have taken control of their mental health with
                        our platform.
                    </p>
                    <Button asChild size="lg">
